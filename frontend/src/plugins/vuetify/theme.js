...
export const staticPrimaryColor = '#336CA3'
export const staticPrimaryDarkenColor = '#142A3E'
export const themes = {
  light: {
    dark: false,
    colors: {
      ...
      'skin-bordered-background': '#f4f5fa',
  ...
  dark: {
    ...
    colors: {
      ...
      'skin-bordered-background': '#142A3E',
      'skin-bordered-surface': '#142A3E',
    ...
    variables: {
      'code-color': '#d400ff',
      'overlay-scrim-background': '#142A3E',
